function loadLoginForm () {
    var loginHtml = `
        ...
        <textarea id="username" rows="5" cols="20" placeholder="Enter your user name here..."></textarea>
        <textarea id="password" rows="5" cols="20" placeholder="Enter your password here"></textarea>
